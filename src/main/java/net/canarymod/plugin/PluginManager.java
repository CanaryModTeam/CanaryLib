...
public interface PluginManager {
    /**
     * Enables the given {@link Plugin}. Loads the plugin if not loaded (and available)
     *
     * @param name
     ...
     *
     * @param log
     *         The {@link Logger} to use when shutting down. This is
     ...
     *
     * @deprecated use {@link PluginManager#disableAllPlugins(org.slf4j.Logger)} instead
     */
    @Deprecated
     ...
     *
     * @param log
     *         The {@link org.slf4j.Logger} to use when shutting down. This is
     *         necessary when in the shutdown hook, since we can't rely on external
     *         libraries there (see the javadoc at
     *         {@link Runtime#addShutdownHook(Thread)})
     */
    void disableAllPlugins(org.slf4j.Logger log);
